...
plt.legend(['ERA5 (10-90)', 'ERA5 Climatology', 'ERA5', 'NEGL', 'IMSW'])

plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_T.png', dpi=600, bbox_inches='tight')
...
plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_WS.png', dpi=600, bbox_inches='tight')
...
plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_RH.png', dpi=600, bbox_inches='tight')
...
plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_SLP.png', dpi=600, bbox_inches='tight')
...
plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_SWR.png', dpi=600, bbox_inches='tight')
...
plt.savefig('../../figures/' + year + '/WeatherStation/Compare_RWay_ERA5_LWR.png', dpi=600, bbox_inches='tight')
